...
`,
    ...
    describe('quickfixes', () => {
        describe('it should add a type with its i18n when the quickfix is applied', () => {
            const projectToCheck = new Project([
                new ProjectSource(
                    'testwrong.graphql',
                    prettyPrint(gql`
...
`);
    ...
    en:
        ...
        describe('it should add a type with its i18n and comments when the quickfix is applied', () => {
            const projectToCheck = new Project([
                new ProjectSource(
                    'testwrong.graphql',
                    prettyPrint(gql`

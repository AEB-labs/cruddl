...
describe('@parent directive', () => {
    ...
    it('rejects with another possible types', () => {
        ...
        `,
            `Type "Child" is used in entity "Root2" as well and thus cannot have a parent field.`
        );
    });
    ...
    it('rejects with other possible types', () => {
        ...
        `,
            `Type "Child" is used in entities "Root2" and "Root3" as well and thus cannot have a parent field.`
        );
    });
    ...
    it('rejects with other possible types when types would not work at all', () => {
        ...
        `,
            `Type "Child" is used in multiple entities ("Root1", "Root2" and "Root3") and thus cannot have a parent field.`
        );
    });
    ...
    it('rejects with multiple possible types through extensions', () => {
        ...
        `,
            `Type "Child" is used in entity "Child2" as well and thus cannot have a parent field.`
        );
    });

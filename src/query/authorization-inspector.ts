...
export class AuthorizationError {
    ...
    toString() {
        ...
        // use field here instead of path because we already throw this at the correct path and it is confusing to show
        // aliases here
        return `Not authorized to ${this.accessKind == AccessKind.WRITE ? 'call' : 'select'} ${this.field.name}` +
            argPart;
    }
}

...
import { getYamlNodePairAtPath, patchBeforeCommentFromParentMap } from './utils';
...
export function generateYamlAddInMapChangesForEnumValueI18n(args: {
    ...
    const baselineTypeConfigs =
        baselineEnumValue.model.i18n.getTypeLocalizationConfigs(enumTypeName);
    const toCheckTypeConfigs = toCheckModelI18n.getTypeLocalizationConfigs(enumTypeName);

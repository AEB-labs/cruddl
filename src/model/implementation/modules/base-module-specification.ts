                ...
                ValidationMessage.error(
                    ...
                    this.config.astNode
                        ? locationWithinStringArgument(
                              ...
                              // result.error.offset can be on the "EOL characeter".
                              // Use at least a width of 1, so we report this on the closing " character
                    ...
                    ValidationMessage.error(
                        ...
                        this.config.astNode
                            ? locationWithinStringArgument(
                                  this.config.astNode,
                                  identifier.offset,
                                  this.expression.length - identifier.name.length,
                              )
                            : undefined,
                    ),
                );

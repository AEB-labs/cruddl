...
import { BinaryOperator, BinaryOperatorWithAnalyzer, QueryNode } from '../../query-tree/index.js';
import {
...
import { NUMERIC_FILTER_FIELDS } from '../filter-input-types/constants.js';
import {
    binaryNotOp,
...
export const FLEX_SEARCH_FILTER_DESCRIPTIONS: {
    ...
    [INPUT_FIELD_NOT]: {
        [GraphQLString.name]:
            'Checks if $field does not equal a specified string, case-insensitively.',
    ...
    [INPUT_FIELD_STARTS_WITH]:
        'Checks if $field starts with a specified string, case-insensitively.',
    [INPUT_FIELD_NOT_STARTS_WITH]:
        'Checks if $field does not start with a specified string, case-insensitively.',
    [INPUT_FIELD_CONTAINS_ANY_WORD]:
...
export const FLEX_SEARCH_FILTER_DESCRIPTIONS_AGGREGATION: {
    ...
    [INPUT_FIELD_EQUAL]: {
        [GraphQLString.name]:
            'Checks if any value in $field equals a specified string, case-insensitively.\n\n',
        ['']: 'Checks if $field equals a specified value.',
    },

    [INPUT_FIELD_NOT]: {
        [GraphQLString.name]:
            'Checks if no value in $field equals a specified string, case-insensitively.',
        ['']: 'Checks if $field does not equal a specified value',
    },

    [INPUT_FIELD_STARTS_WITH]:
        'Checks if any value in $field starts with a specified string, case-insensitively.',
    [INPUT_FIELD_NOT_STARTS_WITH]:

...
export function getOrderByValues(args: any, orderByType: OrderByEnumType, { isAbsoluteOrderRequired }: { readonly isAbsoluteOrderRequired: boolean }): ReadonlyArray<OrderByEnumValue> {

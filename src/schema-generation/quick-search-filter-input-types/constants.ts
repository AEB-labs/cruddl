...
export const QUICK_SEARCH_FILTER_OPERATORS: { [suffix: string]: (fieldNode: QueryNode, valueNode: QueryNode, paramNode?: QueryNode) => QueryNode } = {
    ...
    [INPUT_FIELD_CONTAINS_ANY_WORD]: ternaryOp(TernaryOperator.QUICKSEARCH_IN_TOKENS),
    [INPUT_FIELD_NOT_CONTAINS_ANY_WORD]: ternaryNotOp(TernaryOperator.QUICKSEARCH_IN_TOKENS),
};

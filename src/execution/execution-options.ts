...
export interface ExecutionOptions {
     ...
     *
     * Increase this value when a query accesses many small attributes from large documents and
     * a full document copy should be avoided. The ArangoDB default (when unset) is 5.
     *

            ...
            for (var i1 = 0; i1 < data1.length; i1++) {
              ...
              if ((data2 && typeof data2 === "object" && !Array.isArray(data2))) {
                ...
                for (var key3 in data2) {
                  var isAdditional3 = !(false || key3 == 'roles' || key3 == 'access' || key3 == 'restrictToAccessGroups');
                  if (isAdditional3) {
                    valid4 = false;
                    var err = {
                      keyword: 'additionalProperties',
                    ...
                    for (var i4 = 0; i4 < data3.length; i4++) {
                      ...
                      if (typeof data4 === "string") {
                        if (!pattern1.test(data4)) {
                          var err = {
                            keyword: 'pattern',
                            dataPath: (dataPath || '') + '.permissions[' + i1 + '].roles[' + i4 + ']',
                            schemaPath: '#/definitions/Permission/properties/roles/items/pattern',
                            params: {
                              pattern: '.+'
                            },
                ...
                if (data3 !== undefined) {
                  ...
                  if (typeof data3 === "string") {
                    if (ucs2length(data3) < 1) {
                      var err = {
                        keyword: 'minLength',
                        dataPath: (dataPath || '') + '.permissions[' + i1 + '].restrictToAccessGroups',
                        schemaPath: '#/definitions/Permission/properties/restrictToAccessGroups/minLength',
                        params: {
                          limit: 1
                        },
                        message: 'should NOT be shorter than 1 characters'
                  ...
                  if (Array.isArray(data3)) {
                    ...
                    for (var i4 = 0; i4 < data3.length; i4++) {
                      ...
                      if (typeof data4 === "string") {
                        if (!pattern1.test(data4)) {
                          var err = {
                            keyword: 'pattern',
                            dataPath: (dataPath || '') + '.permissions[' + i1 + '].restrictToAccessGroups[' + i4 + ']',
                            schemaPath: '#/definitions/Permission/properties/restrictToAccessGroups/items/pattern',
                            params: {
                              pattern: '.+'
                            },
                            message: 'should match pattern ".+"'
                        ...
                        var err = {
                          keyword: 'type',
                          dataPath: (dataPath || '') + '.permissions[' + i1 + '].restrictToAccessGroups[' + i4 + ']',
                          schemaPath: '#/definitions/Permission/properties/restrictToAccessGroups/items/type',
                          params: {
                            type: 'string'
                          },
                          message: 'should be string'
                    ...
                    var err = {
                      keyword: 'type',
                      dataPath: (dataPath || '') + '.permissions[' + i1 + '].restrictToAccessGroups',
                      schemaPath: '#/definitions/Permission/properties/restrictToAccessGroups/type',
                      params: {
                        type: 'array'
                      },
                      message: 'should be array'
          ...
          if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
            ...
            for (var key1 in data1) {
              if (pattern3.test(key1)) {
                var errs_2 = errors;
                if (!refVal4(data1[key1], (dataPath || '') + '.types[\'' + key1 + '\']', data1, key1, rootData)) {
              ...
              if (pattern3.test(key1)) {
                ...
                if (!valid2) {
                  ...
                  if (typeof data2 !== "string") {
                    var err = {
                      ...
                      schemaPath: '#/properties/fields/patternProperties/%5E%5Ba-zA-Z0-9_%5D%2B%24/anyOf/1/type',
                      params: {
                        type: 'string'
                      },
                      message: 'should be string'
                ...
                if (!valid2) {
                  var err = {
                    keyword: 'anyOf',
                    dataPath: (dataPath || '') + '.fields[\'' + key1 + '\']',
                    schemaPath: '#/properties/fields/patternProperties/%5E%5Ba-zA-Z0-9_%5D%2B%24/anyOf',
                    params: {},
  ...
  var refVal4 = (function() {
    ...
    return function validate(data, dataPath, parentData, parentDataProperty, rootData) {
      ...
      if ((data && typeof data === "object" && !Array.isArray(data))) {
        ...
        var valid1 = true;
        for (var key0 in data) {
          var isAdditional0 = !(false || key0 == 'fields' || key0 == 'values' || key0 == 'label' || key0 == 'labelPlural' || key0 == 'hint');
          if (isAdditional0) {
            valid1 = false;
            var err = {
              keyword: 'additionalProperties',
              ...
              if (pattern3.test(key1)) {
                ...
                if (!valid2) {
                  ...
                  if (typeof data2 !== "string") {
                    var err = {
                      ...
                      schemaPath: '#/properties/values/patternProperties/%5E%5Ba-zA-Z0-9_%5D%2B%24/anyOf/1/type',
                      params: {
                        type: 'string'
                      },
                      message: 'should be string'
                ...
                if (!valid2) {
                  var err = {
                    keyword: 'anyOf',
                    dataPath: (dataPath || '') + '.values[\'' + key1 + '\']',
                    schemaPath: '#/properties/values/patternProperties/%5E%5Ba-zA-Z0-9_%5D%2B%24/anyOf',
                    params: {},
                    message: 'should match some schema in anyOf'
                  };
                  if (vErrors === null) vErrors = [err];
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          ...
          for (var key1 in data1) {
            if (pattern0.test(key1)) {
              var errs_2 = errors;
              if (!refVal1(data1[key1], (dataPath || '') + '.permissionProfiles[\'' + key1 + '\']', data1, key1, rootData)) {
        ...
        if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
          ...
          for (var key1 in data1) {
            if (pattern2.test(key1)) {
              var errs_2 = errors;
              if (!refVal3(data1[key1], (dataPath || '') + '.i18n[\'' + key1 + '\']', data1, key1, rootData)) {

                        ...
                        if (Array.isArray(data2)) {
                            ...
                            for (var i2 = 0; i2 < data2.length; i2++) {
                                ...
                                if (data3 && typeof data3 === 'object' && !Array.isArray(data3)) {
                                    ...
                                    var data4 = data3.quantityFieldName;
                                    if (data4 !== undefined) {
                                        var errs_4 = errors;
                                        if (typeof data4 === 'string') {
                                            if (!pattern2.test(data4)) {
                                                var err = {
                                                    ...
                                                    dataPath:
                                                        ...
                                                        '].quantityFieldName',
                                                    schemaPath:
                                                        '#/properties/billing/properties/billingEntities/items/properties/quantityFieldName/pattern',
                                                    params: {
                                                        pattern: '^[a-zA-Z0-9_-]+$'
                                                    },
                                                    message: 'should match pattern "^[a-zA-Z0-9_-]+$"'
                                                ...
                                                if (typeof data5 === 'string') {
                                                    if (!pattern2.test(data5)) {
                                                        var err = {
                                                            ...
                                                            schemaPath:
                                                                '#/properties/billing/properties/billingEntities/items/properties/categoryMapping/properties/fieldName/pattern',
                                                            params: {
                                                                pattern: '^[a-zA-Z0-9_-]+$'
                                                            },
                                                            message: 'should match pattern "^[a-zA-Z0-9_-]+$"'

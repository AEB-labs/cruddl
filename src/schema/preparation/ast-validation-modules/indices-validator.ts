...
import {
    DocumentNode, EnumTypeDefinitionNode, GraphQLBoolean, GraphQLInt, GraphQLString, Location, ObjectTypeDefinitionNode,
    StringValueNode,
    ValueNode
} from "graphql";
import {ValidationMessage} from "../validation-message";
import {
    getNamedTypeDefinitionAST, getNodeByName, getRootEntityTypes,
    getTypeNameIgnoringNonNullAndList
} from "../../schema-utils";
import {
    CHILD_ENTITY_DIRECTIVE, ENTITY_EXTENSION_DIRECTIVE, INDEX_FIELDS_FIELD, INDICES_ARG, ROOT_ENTITY_DIRECTIVE,
    VALUE_OBJECT_DIRECTIVE
} from "../../schema-defaults";
import {
    ENUM, ENUM_TYPE_DEFINITION, LIST, OBJECT, OBJECT_FIELD, OBJECT_TYPE_DEFINITION,
    STRING
